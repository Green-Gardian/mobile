...
export default function PerformanceTab() {
  ...
  const weeklyData = [
    { week: 'Week 1', collections: 18, rating: 4.2, efficiency: 85 },
    { week: 'Week 2', collections: 20, rating: 4.5, efficiency: 90 },
    { week: 'Week 3', collections: 17, rating: 4.1, efficiency: 75 },
    { week: 'Week 4', collections: 19, rating: 4.3, efficiency: 85 }
  ];
            ...
            {weeklyData.map((data, index) => (
              <View key={index} style={styles.chartBar}>
                <View style={styles.barContainer}>
                  <View style={[styles.collectionBar, { height: `${(data.collections / 25) * 100}%` }]} />
